<html>
	<head>
		...
		<body>
			...
			<!-- header -->
			<div class="header" align="center"><h1><span style="font-family: &quot;Comic Sans MS&quot;;">AES-256</span></h1></div>
			<!-- formularz -->
				...
				<div class="row justify-content-center align-items-center ">
					<div class="col col-sm-6 ">
						<form method="POST">
							...
							<input type="text" id="oascii" required="required" name="snum"  minlength="32" maxlength="32" aria-describedby="snumHelpBlock"  class="form-control">
							<span id="snumHelpBlock" class="form-text text-muted">32 bajty</span>
							</div>
		...
		if ($mode == 'CBC')
		{
		$encrypted_openssl = openssl_encrypt($data, "AES-256-CBC", 
			$key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $iv);
		}
		else if ($mode == 'ECB')
		{
		$encrypted_openssl = openssl_encrypt($data, "AES-256-ECB", 
			$key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING);
		}
		else if ($mode == 'CFB')
		{
		$encrypted_openssl = openssl_encrypt($message, "AES-256-CFB", 
			$key, OPENSSL_RAW_DATA  , $iv);
		}
		else if ($mode == 'OFB')
		{
		$encrypted_openssl = openssl_encrypt($message, "AES-256-OFB", 
									...
									<div class="container-fluid ">
											<div class="row justify-content-center align-items-center ">
												<div class="col col-sm-12 ">
													...
													<p style="text-align: justify;">AES w wersji 256-bitowej przetwarza 128-bitowe bloki przy użyciu klucza wynoszącego  256-bit&oacute;w. Podczas szyfrowania stosowane są operacje przesuwania, podstawiania i zamiany bit&oacute;w oraz operacje XOR. AES ma zmienną liczbę rund &ndash; jest ona uzależniona od długości klucza i w tej wersji wynosi ona 14.</p>
