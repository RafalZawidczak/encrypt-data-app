<html>
	<head>
		...
		<title>Camellia-128</title>
	</head>
		<body>
			<!-- NAVBAR -->
			<?php include 'src/navbar.php'; ?>
			<!-- header -->
			<div class="header" align="center"><h1><span style="font-family: &quot;Comic Sans MS&quot;;">Camellia-128</span></h1></div>
			<!-- formularz -->
		...
		if(isset($_POST['add']))
		{
			...
			if ($mode == 'CBC')
			{
			$encrypted_openssl = openssl_encrypt($data, "CAMELLIA-128-CBC", 
				$key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $iv);
			}
			else if ($mode == 'ECB')
			{
			$encrypted_openssl = openssl_encrypt($data, "CAMELLIA-128-ECB", 
				$key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING);
			}
			else if ($mode == 'CFB')
			{
			$encrypted_openssl = openssl_encrypt($message, "CAMELLIA-128-CFB", 
				$key, OPENSSL_RAW_DATA  , $iv);
			}
			else if ($mode == 'OFB')
			{
			$encrypted_openssl = openssl_encrypt($message, "CAMELLIA-128-OFB", 
									...
									<div class="container-fluid h-100">
											<div class="row justify-content-center align-items-center h-100">
												<div class="col col-sm-11 ">
													...
													<p style="text-align: justify;">Camellia w wersji 128-bitowej pracuje na kluczu o długości 128 bit&oacute;w. Wielkość bloku tekstu jawnego i szyfrogramu wynosi r&oacute;wnież 128 bit&oacute;w.</p>
													...
													<p style="text-align: justify;">W wersji 128-bitowej wykonywane są 3 powt&oacute;rzenia blok&oacute;w sześciu rund.</p>
